...
game.state.add('play', {
    preload: function() {
        ...
        this.game.load.image('techCoins_coin', 'assets/496_RPG_icons/I_GoldCoin.png');

        this.game.load.image('cursor', 'assets/496_RPG_icons/A_cursor.png');
    ...
    onKilledMonster: function(monster) {
        ...
        // pick a new monster
        this.currentTech = this.monsters.children[this.monsterNum]
